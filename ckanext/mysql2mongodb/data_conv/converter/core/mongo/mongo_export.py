...
def import_json_to_mongodb(db_connection, collection_name, dbname, json_filename, import_dataset=False):
    ...
    try:
        ...
        return True
        print(
            f"Write data from JSON file {json_filename} to MongoDB collection {collection_name} of database {dbname} successfully!")
    except Exception as e:
        print(
            f"Error while writing JSON file {json_filename} to MongoDB collection {collection_name} of database {dbname}")
        print(e)
        raise e
...
def drop_mongodb_database(schema_conv_output_option):
    ...
    try:
        ...
        print(
            f"Error while dropping MongoDB database {schema_conv_output_option.dbname}! Re-check connection or name of database.")
        print(e)
        raise e
...
class MongoSchemaExportConversion(AbstractSchemaConversion):
    """
    MongoDB Export Schema class.
    This class is used for
            - Storing MySQL schema as a collection in MongoDB database.
            - Defining a MongoDB schema validator
            - Creating MongoDB secondary indexes
    """

    def get(self): '''
        In Export Module, this interface is unused
        '''
    pass
    ...
    def set_config(self, schema_conv_init_option, schema_conv_output_option):
        ...
        To set up connections, you need to provide:
                - schema_conv_init_option:_ instance of class ConvInitOption, which specified connection to "Input" database.
